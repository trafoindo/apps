...
class OfflinePartsReplacementScreen extends StatefulWidget {
  ...
  const OfflinePartsReplacementScreen(
      {Key? key, required this.offlinePartsData})
      : super(key: key);
...
class _OfflinePartsReplacementScreenState
    extends State<OfflinePartsReplacementScreen> {
