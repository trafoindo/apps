...
import 'package:trafindo_psa/screen/detail_priority.dart';
import 'package:trafindo_psa/screen/offline_parts.dart';
import 'package:trafindo_psa/screen/online_parts.dart';
import 'package:trafindo_psa/screen/operational_normally.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget _buildPieChart() {
    if (totalTagNumber <= 0) {
      return const Text('There is no Trafo');
    }
